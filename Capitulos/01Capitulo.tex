...
En lo que concierne a las funcionalidades de la plataforma serán limitadas por los siguientes módulos:
	...
	\subsection{Módulo de gráfico de datos}
		...
		\begin{itemize}
			\item  2 unidades de medición inercial MPU 9250 9DOF y LSM9DS1 9DOF. Son dispositivos electrónicos que miden e informan acerca de la velocidad, orientación y fuerzas magnéticas utilizando una combinación de acelerómetros, giróscopos y magnetómetros.
			\item 1 barómetro MS5611 para medir la presión atmosférica.
			\item 1 sistema de navegación por satélite U-blox M8N, el cual utiliza una combinación de las tecnologías Glonass/GPS/Beidou.
		\end{itemize}
