...
\label{cap1:sec:introduccion}
	...
	La primera etapa de este proyecto consiste en obtener los requerimientos del personal interesado en el desarrollo del mismo (\textit{Stakeholders}), que en nuestro caso son personal del \textit{Instituto de Investigación en Señales, Sistemas e Inteligencia Computacional sinc(\textit{i}))} la Dra. Marina Murillo, Ing. Lucas Genzeliz, Ing. Nahuel Denis y el Dr. Guido Sánchez.
...
\begin{itemize}
	...
	\item \textbf{PyCharm\footnote{Página web del IDE https://www.jetbrains.com/pycharm/ }: } es un entorno de desarrollo integrado (IDE) utilizado en la programación de aplicaciones, específicamente en lenguaje Python. Es desarrollado por la compañía JetBrains. Proporciona análisis de código, un depurador gráfico, probador de unidades integrado, integración con sistemas de control de versiones (\ac{VCS}).El mismo está  disponible en dos versiones: \textit{Professional} y \textit{Community}, siendo esta última la elegida por su gratuidad. 
	
	\item \textbf{Qt Designer\footnote{Página web de Qt https://www.qt.io/qt-features-libraries-apis-tools-and-ide/}:} Es un programa (módulo del Framework Qt) para desarrollar interfaces gráficas de usuario o del inglés Graphic User Interface (GUI) multilenguajes debido a que genera un archivo \ac{XML} cuyo contenido es el formato del respectivo \ac{GUI}. Existiendo la posibilidad de convertirlo a Python, que es el lenguaje elegido para el desarrollo del presente proyecto.
	...
	\item \textbf{PyQt4\footnote{Página web sobre la documentación de la herramienta https://www.riverbankcomputing.com/static/Docs/PyQt4/}: } es una biblioteca gráfica de Qt y realizada bajo Python. Esta nos da la opción de poder realizar una interfaz gráfica a nuestra plataforma, para que sea de fácil uso y entendimiento \cite{doc:qt}. Además, el software Qt Designer genera código en Python utilizando esta libería automáticamente.
	
	\item \textbf{Pygame\footnote{Página web de Pygame https://www.pygame.org/wiki/about}:} es un conjunto multiplataforma de módulos de Python	diseñados para la escritura de videojuegos. Incluye gráficos y bibliotecas de sonido diseñado para ser utilizado con el	lenguaje de programación Python. Cuenta con muchos tutoriales, muchos de ellos online.
	...
	\begin{itemize}
		...
		\item Facilitar el seguimiento de una ruta marcada con receptores GNSS.
	\end{itemize}
