...
\label{cap1:sec:introduccion}
	...
	La primera etapa de este proyecto consiste en obtener los requerimientos del personal interesado en el desarrollo del mismo (\textit{Stakeholders}), que en nuestro caso son personal del \textit{El Instituto de Investigación en Señales, Sistemas e Inteligencia Computacional sinc(i))} la Dra. Marina Murillo, Ing. Lucas Genzeliz, Ing. Nahuel Denis y el Ing. Guido Sánchez.
...
\begin{itemize}
	...
	\item \textbf{Pygame\footnote{Página web de Pygame https://www.pygame.org/wiki/about}:} es un conjunto multi-plataforma de módulos de Python	diseñados para la escritura de videojuegos. Incluye gráficos y bibliotecas de sonido diseñado para ser utilizado con el	lenguaje de programación Python. Se distribuye bajo la GNU Lesser General Public License. Cuenta con muchos tutoriales, muchos de ellos online.
