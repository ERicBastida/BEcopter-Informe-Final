...
\begin{resumen}
Este capítulo contiene información sobre el procedimiento que se ha llevado a cabo en el desarrollo de la tercera etapa del proyecto. Esta etapa consiste principalmente en describir los pasos realizados para el armado del vehículo aéreo no tripulado (\ac{VANT}) de tipo cuadricóptero. Además, se incluirán los inconvenientes que se han presentado en el transcurso del desarrollo del mismo con sus respectivas alternativas y/o soluciones. 

% TODO: Consultar si dejar esta parte   
\par Cabe mencionar que el hardware aquí descrito como también las herramientas utilizadas han sido proporcionadas por el\textit{ Instituto de Investigación en Señales, Sistemas e Inteligencia sinc(i)} con sede en la Facultad de Ingeniería y Ciencias Hídricas de la Universidad Nacional del Litoral y todo procedimiento riesgoso para el alumno ha sido siempre supervisado bajo personal idóneo en el tema.
...
\label{cap2:sec:hardware}
	...
	\subsection{Estructura del vehículo}
		...
		La estructura del cuadricóptero como se puede ver en la Fig. \ref{fig:estrucuadricoptero} consta en su parte inferior de un patín de aterrizaje que cumplen la función (como en los helicópteros) de soportar el vehículo cuando se apoye sobre tierra y mantener las hélices lo más alejado posible de piso cuando se encuentra en reposo. En su parte superior proporciona una base donde es posible instalar los dispositivos electrónicos que controlan al vehículo. Por último, desde la base se extienden 4 brazos con la función de ser soporte a los motores con sus respectivas hélices y además, en cada motor se le incluye su controlador electrónico de velocidad o ESC (\textit{Electronic Speed Controller}). 
	...
	\subsection{Esquema de las conexiones del hardware}
		...
		\begin{figure}[h!]
			\centering
			\includegraphics[width=\linewidth, height=0.3\textheight]{Imagenes/diagramaBloqueConexiones}
		...
		\begin{figure}[h!]
			\centering
			\includegraphics[width=\linewidth, height=0.3\textheight]{Imagenes/diagramaBloqueConexionesFinal}
