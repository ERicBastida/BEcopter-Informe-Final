...
\label{cap2:sec:hardware}
	...
	\subsection{Batería LiPo}
		...
		La batería LiPo (Litio y Polímero) son baterías recargables, compuestas generalmente de varias células conectadas en paralelo para aumentar la capacidad de la corriente de descarga. Esta contiene un voltaje de 12v con 2200 mAh, suministrando dicha energía a los motores y además a la Raspberry Pi con 5V.
		\begin{figure}[h!]
			\centering
