...
%---------------------------------------------------------------------
%
% Contiene la definici�n de las macros para crear las p�ginas de
% dedicatorias.
%
%---------------------------------------------------------------------
...
% Si no hemos puesto a�n el marcador en el PDF, lo ponemos
...
% \dedicatoriaUnoVal
% \end{flushright}
% % \hfill \emph{Al duque de B�jar}

% % \hfill \emph{y\qquad\quad}

% % \hfill \emph{a t�, lector car�simo}
