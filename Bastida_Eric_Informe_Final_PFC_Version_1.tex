...
|
% Capitulos
\include{Capitulos/00Capitulo}    % JOA
\include{Capitulos/01Capitulo}    % Obtencion de los requerimientos
\include{Capitulos/02Capitulo}    % Gestión del hardware y armado 
\include{Capitulos/03Capitulo}    % Desarrollo de la plataforma
%\include{Capitulos/04Capitulo}   % Pruebas
%\include{Capitulos/05Conclusion} % Conclusión


% Apendices
\appendix
\include{Apendices/ParteApendices}
\include{Apendices/01ApendiceA}     %Documentacion - ERS - GUI - Diagrama de clases
%\include{Apendices/01ApendiceB}    %Deberia estar el código (consultar antes a la cátedra)
